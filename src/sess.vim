...
nnoremap <silent>  :noh
map [B <Down> 
nmap -= i// Debuggg <BS><BS><BS>>std::cerr << " " << std::endl;6bli
map Q gq
...
set mouse=a
set ruler
set runtimepath=~/.vim/bundle/vundle,~/.vim/bundle/supertab,~/.vim/bundle/vim-easymotion,~/.vim/bundle/nerdtree,~/.vim/bundle/nerdcommenter,~/.vim/bundle/jellybeans.vim,~/.vim/bundle/vim-numbertoggle,~/.vim,~/lib/applications/vim74_SLC6/share/vim/vimfiles,~/lib/applications/vim74_SLC6/share/vim/vim74,~/lib/applications/vim74_SLC6/share/vim/vimfiles/after,~/.vim/after,~/.vim/syntax/,~/.vim/bundle/vundle/,~/.vim/bundle/vundle/after,~/.vim/bundle/supertab/after,~/.vim/bundle/vim-easymotion/after,~/.vim/bundle/nerdtree/after,~/.vim/bundle/nerdcommenter/after,~/.vim/bundle/jellybeans.vim/after,~/.vim/bundle/vim-numbertoggle/after
set showcmd
set tabstop=3
let s:so_save = &so | let s:siso_save = &siso | set so=0 siso=0
let v:this_session=expand("<sfile>:p")
silent only
cd /afs/cern.ch/work/d/denglert/public/projects/PKPCorrelation_SLC6/CMSSW_5_3_20/src/denglert/PKPCorrelationAna/src
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 32 - ((20 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
32
